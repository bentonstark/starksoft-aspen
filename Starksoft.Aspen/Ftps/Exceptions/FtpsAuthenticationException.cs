...
namespace Starksoft.Aspen.Ftps
{
    ...
    /// </summary>
    [Serializable()]
    public class FtpsAuthenticationException : FtpsException
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public FtpsAuthenticationException()
        {
        }
        ...
        public FtpsAuthenticationException(string message)
            : base(message)
        {
        }
        ...
        public FtpsAuthenticationException(string message, Exception innerException)
            :
        ...
        protected FtpsAuthenticationException(SerializationInfo info,
