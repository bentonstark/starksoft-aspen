...
namespace Starksoft.Aspen.Ftps
{
    ...
    /// </summary>
    [Serializable()]
    public class FtpsNetworkVersionException : FtpsException
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public FtpsNetworkVersionException()
        {
        }
        ...
        public FtpsNetworkVersionException(string message)
            : base(message)
        {
        }
        ...
        public FtpsNetworkVersionException(string message, Exception innerException)
            :
        ...
        protected FtpsNetworkVersionException(SerializationInfo info,
