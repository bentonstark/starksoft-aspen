...
namespace Starksoft.Aspen.Ftps
{
    ...
    /// </summary>
    [Serializable()]
    public class FtpsFeatureException : FtpsException
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public FtpsFeatureException()
        {
        }
        ...
        public FtpsFeatureException(string message)
            : base(message)
        {
        }
        ...
        public FtpsFeatureException(string message, Exception innerException)
            :
        ...
        protected FtpsFeatureException(SerializationInfo info,
