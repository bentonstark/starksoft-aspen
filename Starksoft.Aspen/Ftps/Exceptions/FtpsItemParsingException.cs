...
namespace Starksoft.Aspen.Ftps
{
    ...
    /// </summary>
    [Serializable()]
    public class FtpsItemParsingException : FtpsException
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public FtpsItemParsingException()
        {
        }
        ...
        public FtpsItemParsingException(string message)
            : base(message)
        {
        }
        ...
        public FtpsItemParsingException(string message, Exception innerException)
            :
        ...
        protected FtpsItemParsingException(SerializationInfo info,
