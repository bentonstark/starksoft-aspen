...
namespace Starksoft.Aspen.Ftps
{
    ...
    /// </summary>
    [Serializable()]
    public class FtpsCommandResponseTimeoutException : FtpsException
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public FtpsCommandResponseTimeoutException()
        {
        }
        ...
        public FtpsCommandResponseTimeoutException(string message)
            : base(message)
        {
        }
        ...
        public FtpsCommandResponseTimeoutException(string message, Exception innerException)
            :
        ...
        protected FtpsCommandResponseTimeoutException(SerializationInfo info,
