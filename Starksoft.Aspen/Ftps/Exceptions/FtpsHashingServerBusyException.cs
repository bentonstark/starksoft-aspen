...
namespace Starksoft.Aspen.Ftps
{
    ...
    /// </summary>
    [Serializable()]
    public class FtpsHashingServerBusyException : FtpsHashingException
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public FtpsHashingServerBusyException()
        {
        }
        ...
        public FtpsHashingServerBusyException(string message)
            : base(message)
        {
        }
        ...
        public FtpsHashingServerBusyException(string message, Exception innerException)
            :
        ...
        protected FtpsHashingServerBusyException(SerializationInfo info,
